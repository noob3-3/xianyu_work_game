...
public class AskQuestionOne extends AppCompatActivity {
    ...
    public List<Brain_Teasers_Data.ResultBean.ListBean> data;
...
//            CurrentNumber++;
    ...
    private void initOnClickListener() {
        ...
        MakeSure.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    // 提示分数信息 返回上一层
                    Toast.makeText( AskQuestionOne.this,"您的分数是"+CurrentScore+"分",Toast.LENGTH_SHORT ).show();
                    finish();
                }else {
                    if("".equals(Answer.getText().toString()))
                    {
                        Toast.makeText( AskQuestionOne.this,"您还没有答题哦^_^",Toast.LENGTH_SHORT ).show();
                    }else{
                        Question.setText( data.get( CurrentNumber ).getContent()+"" );
                        CurrentNumber++;
    ...
    public List<Brain_Teasers_Data.ResultBean.ListBean> getThisData() {
